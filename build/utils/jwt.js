...
const generateAccessToken = (userId, name, email, organizacion) => {
    const payload = { id: userId, name, email, organizacion: String(organizacion) };
...
const generateRefreshToken = (userId, name, email, organizacion) => {
    const payload = { id: userId, name, email, organizacion: String(organizacion) };
